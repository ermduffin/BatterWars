...
HXLINE(  18)		::lime::_hx_system::System_obj::_hx___registerEntryPoint(HX_("BatterWars",b7,57,c6,82),::ApplicationMain_obj::create_dyn());
...
HXLINE(  37)		app->meta->set(HX_("file",7c,ce,bb,43),HX_("BatterWars",b7,57,c6,82));
HXLINE(  38)		app->meta->set(HX_("name",4b,72,ff,48),HX_("BatterWars",b7,57,c6,82));
...
HXLINE(  46)		 ::Dynamic attributes =  ::Dynamic(::hx::Anon_obj::Create(16)
            			...
            			->setFixed(2,HX_("width",06,b6,62,ca),600)
            			...
            			->setFixed(7,HX_("height",e7,07,4c,02),450)
            			->setFixed(8,HX_("element",bc,ae,54,06),null())
            			->setFixed(9,HX_("title",98,15,3b,10),HX_("BatterWars",b7,57,c6,82))
