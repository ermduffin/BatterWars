...
HXLINE( 507)			_hx_tmp1 = (point->x < Camera->viewOffsetWidth);
            		}
            		else {
HXLINE( 507)			_hx_tmp1 = false;
            		}
HXDLIN( 507)		if (_hx_tmp1) {
HXLINE( 507)			_hx_tmp = ((point->y + (this->_scaledTileHeight * ( (Float)(this->heightInTiles) ))) > Camera->viewOffsetY);
            		}
            		else {
HXLINE( 507)			_hx_tmp = false;
            		}
HXDLIN( 507)		if (_hx_tmp) {
HXLINE( 507)			return (point->y < Camera->viewOffsetHeight);
            		}
            		else {
